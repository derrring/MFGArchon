- **The four 2-D capability cells solve to a fixed point and read the PDE the fixture states** (Issue #1745).
  ...
  - **Not seen:** a band of diffusion errors passes (x0.5 and x0.75 pass every FDM and SL cell; x0.75 and x1.5 pass FVM_MUSCL), and so do doubled diffusion in the HJB-FDM path alone, a control cost of 0.5 or 2 in the solvers with the oracle kept at 1, `drift_coefficient_2x` and the pre-#2308 upwind rule. `_mass_conservation_2d_cell`'s docstring lists each with its measurement.
