...
REFERENCE: list[tuple[str, list, tuple, list, list]] = [
    ...
    (
        ...
        [[-1.0, 3.0], [0.0, 1.0]],
        (0, 1),
        [[-1.2780808160096675, -7.916648193178071], [-3.213968021433959, 1.2182901642096475], [3.3636139815802686, 7.2918189138922305], [-4.480977606486634, -5.304746482623764], [-6.682908026456461, -1.5937908523025182], [7.929504265123851, -5.613788770813995]],
        [[-1.2780808160096675, 0.08335180682192878], [0.786031978566041, 0.21829016420964753], [-0.6363860184197314, 0.29181891389223047], [-0.48097760648663357, -0.3047464826237638], [1.3170919735435387, 0.40620914769748184], [-0.07049573487614857, 0.3862112291860047]],
    ),
    (
        '2d-second-axis-only',
        [[-1.0, 3.0], [0.0, 1.0]],
        (1,),
        [[5.09030781716905, -4.718544065939266], [-5.474539101043742, 4.04338868045852], [-8.908169239492473, -2.1389053009552326], [1.6221354769785281, 0.8314052065743427], [0.03333820760525397, -5.701619056288758]],
        [[5.09030781716905, 0.2814559340607339], [-5.474539101043742, 0.04338868045851996], [-8.908169239492473, -0.13890530095523257], [1.6221354769785281, -0.1685947934256573], [0.03333820760525397, 0.29838094371124235]],
    ),
    (
        '2d-reversed-order',
        [[-1.0, 3.0], [0.0, 1.0]],
        (1, 0),
        [[-3.361553472086714, 4.16994937597276], [6.904950942209215, 8.972463686510158], [3.3237568227028187, 7.720533737847077], [-7.5646755659393365, 0.8469216314794283], [0.13951731154422875, -7.003103997362217]],
        [[0.638446527913286, 0.16994937597276039], [-1.095049057790785, -0.027536313489841646], [-0.6762431772971813, -0.2794662621529227], [0.43532443406066346, -0.15307836852057166], [0.13951731154422875, -0.0031039973622171146]],
    ),
    (
        '3d',
        [[0.0, 2.0], [0.0, 1.0], [-1.0, 1.0]],
        (0, 2),
        [[6.217999846695465, -6.178937521674154, 5.389898643988186], [1.631577705882292, 3.236544287010334, -1.2328615544041215], [2.062672677550483, 1.9899315367914652, 5.355509591043985], [5.613699362055087, 2.2234722851819173, -3.898601223973963], [-4.706337974591535, -6.8395720010007945, 1.1874189606593606]],
        [[0.21799984669546468, -6.178937521674154, -0.610101356011814], [-0.368422294117708, 3.236544287010334, 0.7671384455958785], [0.06267267755048289, 1.9899315367914652, -0.6444904089560151], [-0.3863006379449132, 2.2234722851819173, 0.10139877602603686], [-0.706337974591535, -6.8395720010007945, -0.8125810393406394]],
    ),
    (
        'none-periodic',
        [[0.0, 1.0], [0.0, 1.0]],
        (),
        [[0.30455534725633515, 0.1490804207118861], [0.41577309417224173, 1.996582577356231], [1.738761981013141, 0.6144008098554237], [0.9094611902609546, -2.208752658105409]],
        [[0.30455534725633515, 0.1490804207118861], [0.41577309417224173, 1.996582577356231], [1.738761981013141, 0.6144008098554237], [0.9094611902609546, -2.208752658105409]],
    ),
    (
        'single-vector-1d',
...
@pytest.mark.parametrize(("label", "bounds", "periodic_dims", "delta", "expected"), REFERENCE, ids=[c[0] for c in REFERENCE])
