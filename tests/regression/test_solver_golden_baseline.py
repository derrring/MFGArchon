...
# before T (the terminal row is U = 0), and that is where the diff sits: max|dU| 3.313e-05 (rel
# 7.81e-04) at (t=0, col 10), max|dM| 6.464e-04 (rel 2.09e-04) at (t=3, col 10). The GFDM fixture
# regenerated byte-identical, the control: that path never reads `gradient_upwind`.
#
