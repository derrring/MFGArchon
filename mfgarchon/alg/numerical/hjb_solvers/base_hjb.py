...
def _get_bc_info_1d(
    ...
    default_value = bc.get_bc_value_at_boundary(target_face.to_string(), time=time)
    return (
        bc.default_bc,
...
def compute_hjb_jacobian(
    ...
    if backend is not None:
        from mfgarchon.backends.compat import to_numpy
...
def solve_hjb_timestep_newton(
    ...
    if bc is not None:
        ...
        if left_type == BCType.DIRICHLET:
            ...
            # segment -- the documented usage at types.py:345 -- crashed Auto Mode.
